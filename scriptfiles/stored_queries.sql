...
createPlayerTable NA CREATE TABLE IF NOT EXISTS players(PlayerName VARCHAR(24) PRIMARY KEY NOT NULL, PlayerPassword VARCHAR(32) NOT NULL, PlayerIP VARCHAR(32) NOT NULL, PlayerLevel INTEGER NOT NULL, PlayerScore INTEGER NOT NULL, PlayerMoney INTEGER NOT NULL);
createPlayer sssddd INSERT INTO players (PlayerName,PlayerPassword, PlayerIP, PlayerLevel, PlayerScore, PlayerMoney) VALUES ('%s','%s','%s',%d,%d,%d);
